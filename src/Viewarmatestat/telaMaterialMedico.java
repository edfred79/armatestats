 ...
 */
public class telaMaterialMedico extends javax.swing.JFrame {

    /**
     * Creates new form telaMaterialMedico
     */
    public telaMaterialMedico() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Viewarmatestat/images/into-instituto-nacional-de-traumatologia-e-ortopedia3521.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(telaMaterialMedico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new telaMaterialMedico().setVisible(true);
            }
        });
    }
